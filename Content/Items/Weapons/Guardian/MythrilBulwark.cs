...
{
    // First Hardmode shield (Hardmode ore). Aura inflicts Frostburn. Not
    // subclass-locked. Reuses the TrainingShield texture until real art exists.
    public class MythrilBulwark : ModItem, IShieldWeapon
    {
        public override string Texture =>
            "ETERNIA/Content/Items/Weapons/Guardian/TrainingShield";

        public int AuraPulseInterval => 16;
        public float AuraRadius => 86f;
        public Color AuraColor => new Color(140, 210, 200);
        ...
        {
            CreateRecipe()
                .AddRecipeGroup("EterniaMythril", 14)
